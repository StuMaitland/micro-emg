...
public:
    ...
    static void addDataStreamListener(DataStreamListener * listener);
...
private slots:
    ...
    void saveImpedances();
    //Added  by Bashar
    void saveImpedances(QString fname);
    //
    ...
    void endRecording();
private:
    MainWindow(){init();};//Singleton Design Pattern
    void init();
    ...
    // add extra button to run the experiment
    QPushButton *runExperimentButton;
    //******************************
    ...
    static QVector<DataStreamListener*> dataListeners;
