...
{
    //QMessageBox::information(0, "FPGA Configuration File Upload Test",
      //                   "Testing Upload");
    okCFrontPanel::ErrorCode errorCode = dev->ConfigureFPGA(filename);
    switch (errorCode) {
        case okCFrontPanel::NoError:
        //    QMessageBox::information(0, "FPGA Configuration File Upload Test","No Error");
            break;
        case okCFrontPanel::DeviceNotOpen:
            cerr << "FPGA configuration failed: Device not open." << endl;
          //  QMessageBox::information(0, "FPGA Configuration File Upload Test","FPGA configuration failed: Device not open.");
            return(false);
        case okCFrontPanel::FileError:
            cerr << "FPGA configuration failed: Cannot find configuration file." << endl;
            //QMessageBox::information(0, "FPGA Configuration File Upload Test","FPGA configuration failed: Cannot find configuration file.");
            return(false);
        case okCFrontPanel::InvalidBitstream:
            cerr << "FPGA configuration failed: Bitstream is not properly formatted." << endl;
            //QMessageBox::information(0, "FPGA Configuration File Upload Test","FPGA configuration failed: Bitstream is not properly formatted.");
            return(false);
        case okCFrontPanel::DoneNotHigh:
            cerr << "FPGA configuration failed: FPGA DONE signal did not assert after configuration." << endl;
            //QMessageBox::information(0, "FPGA Configuration File Upload Test","FPGA configuration failed: FPGA DONE signal did not assert after configuration.");
            return(false);
        case okCFrontPanel::TransferError:
            cerr << "FPGA configuration failed: USB error occurred during download." << endl;
            //QMessageBox::information(0, "FPGA Configuration File Upload Test","FPGA configuration failed: USB error occurred during download.");
            return(false);
        case okCFrontPanel::CommunicationError:
            cerr << "FPGA configuration failed: Communication error with firmware." << endl;
            //QMessageBox::information(0, "FPGA Configuration File Upload Test","FPGA configuration failed: Communication error with firmware.");
            return(false);
        case okCFrontPanel::UnsupportedFeature:
            cerr << "FPGA configuration failed: Unsupported feature." << endl;
            //QMessageBox::information(0, "FPGA Configuration File Upload Test","FPGA configuration failed: Unsupported feature.");
            return(false);
        default:
            cerr << "FPGA configuration failed: Unknown error." << endl;
            //QMessageBox::information(0, "FPGA Configuration File Upload Test","FPGA configuration failed: Unknown error.");
            return(false);
    }
