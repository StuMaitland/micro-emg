...
static const char qt_meta_stringdata_SetSaveFormatDialog[] = {
...
const QMetaObjectExtraData SetSaveFormatDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SetSaveFormatDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SetSaveFormatDialog,
      qt_meta_data_SetSaveFormatDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SetSaveFormatDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SetSaveFormatDialog))
