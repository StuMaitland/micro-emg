...
static const char qt_meta_stringdata_SummaryView[] = {
    "SummaryView\0\0run()\0"
};

void SummaryView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        SummaryView *_t = static_cast<SummaryView *>(_o);
        switch (_id) {
        case 0: _t->run(); break;
        default: ;
        }
...
const QMetaObjectExtraData SummaryView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SummaryView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SummaryView,
      qt_meta_data_SummaryView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SummaryView::getStaticMetaObject() { return staticMetaObject; }
